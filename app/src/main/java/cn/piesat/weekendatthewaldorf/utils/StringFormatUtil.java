package cn.piesat.weekendatthewaldorf.utils;
...
public class StringFormatUtil {
     ...
     * 格式化导演、主演名字
     */
    public static String formatName(List<MovieSubjectInfoEntity.DirectorsBean> casts) {
    ...
    public static String formatCasts(List<MovieSubjectInfoEntity.CastsBean> casts) {
        if (casts != null && casts.size() > 0) {
            StringBuilder stringBuilder = new StringBuilder();
            for (int i = 0; i < casts.size(); i++) {
                if (i < casts.size() - 1) {
